  ...
  <script type="text/javascript" src="{{asset('backend/asset/js/jquery-ui-1.9.2.custom.min.js')}}"></script>
  <!-- bootstrap -->
  ...
  <script src="{{asset('backend/asset/js/jquery.sparkline.js')}}" type="text/javascript"></script>
  ...
  <<script src="{{asset('backend/asset/js/fullcalendar.min.js')}}"></script>
    <!-- Full Google Calendar - Calendar -->
    <script src="{{asset('backend/asset/assets/fullcalendar/fullcalendar/fullcalendar.js')}}"></script>
    <!--script for this page only-->
    <script src="{{asset('backend/asset/js/calendar-custom.js')}}"></script>
    ...
    <script src="{{asset('backend/asset/js/xcharts.min.js')}}"></script>
